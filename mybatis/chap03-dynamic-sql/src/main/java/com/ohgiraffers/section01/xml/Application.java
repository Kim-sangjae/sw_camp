...
public class Application {
    ...
    private static void trimSubMenu() {
        ...
        do {
            ...
            System.out.println("1. 메뉴 혹은 카테고리 코드로 검색, 단 메뉴와 카테고리 둘 다 일치하는 경우도 " +
                    "검색하며, 검색 조건이 없는 경우에는 전체 검색");
    ...
    private static Map<String, Object> inputSearchCriteriaMap() {
        Scanner sc = new Scanner(System.in);
        System.out.print("검색하실 기준 입력(name or category or both or null) : ");
        String condition = sc.nextLine();

        HashMap<String, Object> criteria = new HashMap<>();
        if("category".equals(condition)) {
            System.out.print("검색하실 카테고리 코드 : ");
            int categoryValue = sc.nextInt();
            criteria.put("categoryValue", categoryValue);
        } else if("name".equals(condition)) {
            System.out.print("검색하실 메뉴명 : ");
    ...
    private static void chooseSubMenu() {
        ...
        do {
            ...
            switch (no) {
                case 1 : menuService.selectMenuSupCategory(inputSupCategory()); break;
                case 9 : return;
            }
        } while(true);
    }
    ...
    private static SearchCriteria inputSupCategory() {
        Scanner sc = new Scanner(System.in);
        System.out.print("상위 카테고리 입력(식사, 음료, 디저트) : ");
    ...
    private static SearchCriteria inputSearchCriteria() {
        Scanner sc = new Scanner(System.in);
        System.out.print("검색하실 기준 입력(name or category) : ");
        String condition = sc.nextLine();
        System.out.print("검색하실 키워드 입력 : ");
        String value = sc.nextLine();
